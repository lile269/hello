...
// libYYFaceWidget
#define COCOAPODS_POD_AVAILABLE_libYYFaceWidget
#define COCOAPODS_VERSION_MAJOR_libYYFaceWidget 1
#define COCOAPODS_VERSION_MINOR_libYYFaceWidget 0
#define COCOAPODS_VERSION_PATCH_libYYFaceWidget 0
